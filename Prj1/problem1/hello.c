...
//dfs process tree
void dfs_ptree(struct task_struct* root,struct prinfo* buf, int *nr)
{
    ...
    {
        dfs_ptree(list_entry(pos,struct task_struct,sibling),buf,nr);
    }
}
...
int ptree(struct prinfo *buf, int *nr)
{
    ...
    dfs_ptree(&init_task,ker_buf,ker_nr);
